  ...
  <div class="container py-3 flex justify-between items-center">
    ...
    <nav class="flex items-center">
      <div class="flex space-x-6 xl:text-lg font-semibold text-tersiaire">
        ...
        <a href="#" class="inline-block nav-link">A propos</a>
      ...
      <div class="ml-4 xl:text-lg">
        <a href="#" class=" nav-btn bg-opacity-80 bg-secondary text-white font-semibold"><span>Demander un devis</span> <i class="fa-solid ml-2 fa-arrow-right-long devis"></i></a>
        <a href="#" class="nav-btn border-2 font-semibold"><i class="fa-brands fa-whatsapp mr-2 text-xl text-green-600"></i> Whatsapp</a>
      </div>
    </nav>
  </div>
</header>
